...
All Sentinel packages are licensed under the GNU General Public License v3.0 or later (GPL v3). By contributing, you agree that your contributions will be licensed under GPL v3 or later. See the LICENSE file in each package for details.
